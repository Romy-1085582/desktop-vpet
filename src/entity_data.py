...
FOOD_DATA = {
    0: {"name": "Croissant", "description": "fr*nch", "sprite": "croissant.png", "cost": 3, "nutrition_value": 20, "is_bouncy": False},
    1: {"name": "Energy Drink", "description": "monter...", "sprite": "energy_drink.png", "cost": 4, "nutrition_value": 5, "is_bouncy": False},
    2: {"name": "Cup Noodles", "description": "they put noodles in a cup this is unbelievaaable.", "sprite": "cup_noodles.png", "cost": 2, "nutrition_value": 30, "is_bouncy": False},
    3: {"name": "Worm", "description": "webfishing whaoaoahh", "sprite": "worm.png", "cost": 5, "nutrition_value": 15, "is_bouncy": False},
}
